...
class Dali  {
    public:
        Dali(){};
        Dali(gpio_num_t tx, gpio_num_t rx, adc_channel_t chan, dali_callback_t cb)
        {
            initialize(tx,rx,chan,cb);
        }
        ~Dali() {};
        void initialize(gpio_num_t tx, gpio_num_t rx,  adc_channel_t chan, dali_callback_t cb);
